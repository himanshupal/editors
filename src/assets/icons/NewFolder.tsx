const NewFolder = ({ width = 24, height = 24, color = 'currentColor', className = 'icon', onClick = () => {} }) => (
	<svg className={className} fill={color} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={width} height={height} onClick={onClick}>
